...
class TestClarabelDirect:
    ...
    def test_sample_covariance(self, benchmark, n):
        ...
        def solve():
            """Build and solve the sample-covariance min-risk problem, returning the weights."""
    ...
    def test_factor_model(self, benchmark, assets, k):
        ...
        def solve():
            """Build and solve the factor-model min-risk problem, returning the weights."""
            problem = minrisk_problem(model, weights)
            problem.solve()
            return weights.value
...
class TestCvxpy:
    ...
    def test_sample_covariance(self, benchmark, n):
        ...
        def solve():
            """Construct and solve the cvxpy sample-covariance min-risk problem, returning the weights."""
            w = cp.Variable(n)
            risk = cp.norm(L @ w, 2)
            constraints = [
                cp.sum(w) == 1,
    ...
    def test_factor_model(self, benchmark, assets, k):
        ...
        def solve():
            """Construct and solve the cvxpy factor-model min-risk problem, returning the weights."""
